 ...
 */
class Concentre_Form_Decorator_JsValidation extends Zend_Form_Decorator_Abstract 
{
	/**
	...
	public function __construct($options = array())
	{
		...
		if(isset($options['javaScriptPath']))
			...
			$this->_javaScriptPath = Zend_Controller_Front::getInstance()->getBaseUrl() . '/share/js/';
