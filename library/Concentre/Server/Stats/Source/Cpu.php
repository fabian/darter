<?php
/**
 * $Id: cpu.php 127 2006-04-25 11:18:09Z goliath $
 *
...
class Concentre_Server_Stats_Source_Cpu
		extends Concentre_Server_Stats_Source_Abstract 
		implements Concentre_Server_Stats_Source_Cached, Concentre_Server_Stats_Source_Rrd
{
	private $path_stat;
	...
	{
		$this->path_stat = $args['path_stat']?$args['path_stat']:'/proc/stat';
	}
